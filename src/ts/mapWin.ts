import { MsdpVal, MsdpVarName } from "./telnetClient";
...
export class MapWin {
    ...
    private updateRoomName() {
        let room_name = stripColorTags(this.roomName);
    ...
    public handleMsdpVar(varName: MsdpVarName, value: MsdpVal) {
        switch (varName) {
            case "EDIT_MODE":
                this.editMode = value as string;
                this.updateOlcStatus();
                break;
            case "EDIT_VNUM":
                this.editVnum = value as string;
                this.updateOlcStatus();
                break;
            case "ROOM_NAME":
                this.roomName = value as string;
                this.updateRoomName();
                break;
            case "ROOM_VNUM":
                this.roomVnum = value as string;
                this.updateRoomName();
                break;
            case "ROOM_SECTOR":
                this.roomSector = value as string;
                this.updateRoomName();
                break;
            case "ROOM_EXITS":
                let val;
